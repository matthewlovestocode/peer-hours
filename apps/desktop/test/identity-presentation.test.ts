...
test("records trust copy never upgrades raw history to settlement finality", () => {
  const ready = recordsTrustStatus({ state: "ready", publishedListings: [], proposedProposals: [], acceptedProposals: [], settlementConfirmations: [], settlementAttestations: [], settledProposalIds: [], transferCount: 0 }, 2);
